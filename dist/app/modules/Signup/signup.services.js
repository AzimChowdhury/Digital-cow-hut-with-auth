...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.Users.isUserExist(phoneNumber);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "User does not exist");
    }
    if ((yield user_model_1.Users.isPasswordMatched(password, isUserExist.password)) === false) {
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.Users.isUserExist(_id);
    if (!isUserExist) {
